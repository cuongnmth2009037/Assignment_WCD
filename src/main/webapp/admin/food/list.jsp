                                    ...
                                    <div class="table-responsive">
                                        <table id="add-row" class="display table table-striped table-hover" >
                                            ...
                                            <tr>
                                                ...
                                                <td><%= food.getAvatar() %></td>
                                                <td><%= food.getPrice() %></td>
                                                <td><%= food.getStartDate() %></td>
                                                <td><%= food.getStatus() %></td>
                                                <td>
                                                    <div class="form-button-action">
                                                        <a href="/food/update?id=<%= food.getId() %>" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task">
                                                        ...
                                                        <button class="btn btn-link btn-danger btn-lg" data-bs-toggle="modal" data-bs-target="#exampleModal<%= food.getId() %>"><i class="fa fa-times"></i></button>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="/food/delete?id=<%= food.getId() %>" class="btn btn-danger">Delete</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
