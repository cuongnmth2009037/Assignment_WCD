                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <a href="/category/update?id=<%= category.getId() %>" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <%--<a href="/category/update?id=<%= category.getId() %>" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger btn-lg" data-original-title="Edit Task">
                                                            <i class="fa fa-times"></i>
                                                        </a>--%>
                                                        <button class="btn btn-link btn-danger btn-lg" data-bs-toggle="modal" data-bs-target="#exampleModal<%= category.getId() %>"><i class="fa fa-times"></i></button>
